...
export class SubscriptionManager {
    constructor(env, { orm, notification }) {
        ...
        console.log(session.subscription, "this is the subscription info from session");
        if (session.expiration_date) {
            ...
            console.warn("No expiration date found in session, defaulting to 30 days from now"
